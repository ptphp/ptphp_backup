...
if(('webkitSpeechRecognition' in window)){
  ...
  App.speechCommand('go to',{
    action: function(){
      ...
      image: '/static/theme/cleanzone/images/mic-icon.png',
      class_name: 'clean',
      time: ''
      });          
    },
    listen: function(datos){
      switch(datos){
        ...
        case "500 page": location.href = "pages-500.html?listen=on"; break;
        default:
          $.gritter.add({title: "Error",text: "Could not find: <strong>" + datos + "</strong> page, Please try again.",image: '/static/theme/cleanzone/images/mic-icon.png',class_name: 'clean',time: ''});
        break;
      }
    }
  });
  ...
  var hello_actions = {
    action: function(){
      ...
      image: '/static/theme/cleanzone/images/user-icon.png',
      class_name: 'clean',
      time: ''
      });
    },
