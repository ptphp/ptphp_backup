...
else{for(m=b-1;void 0==(r=e.tests[m])&&-1<m;)m--;void 0!=r&&-1<m&&(l=m,a=r[0].locator.slice())}}for(m=a.shift();m<d.length&&!(h(d[m],a,[m])&&l==b||l>b);m++);(0==c.length||f&&2>c.length)&&c.push({match:{fn:null,cardinality:0,optionality:!0,casing:null,def:""},locator:[]});return e.tests[b]=c}function n(){void 0==e._buffer&&(e._buffer=g(!1,1));return e._buffer}function h(){void 0==e.buffer&&(e.buffer=g(!0,u(),!0));return e.buffer}function f(b,d){for(var e=h().slice(),c=b;c<d;c++)e[c]!=P(c)&&e[c]!=a.skipOptionalPartCharacter&&
k(c,e[c],!0,!0)}function r(b,d){switch(d.casing){case "upper":b=b.toUpperCase();break;case "lower":b=b.toLowerCase()}return b}function k(b,m,E,c){function k(b,m,c,E){var l=!1;d.each(v(b),function(N,k){for(var g=k.match,F=m?1:0,q="",n=h(),s=g.cardinality;s>F;s--)q+=void 0==e.validPositions[b-(s-1)]?P(b-(s-1)):e.validPositions[b-(s-1)].input;m&&(q+=m);l=null!=g.fn?g.fn.test(q,n,b,c,a):m!=g.def&&m!=a.skipOptionalPartCharacter||""==g.def?!1:{c:g.def,pos:b};if(!1!==l){F=void 0!=l.c?l.c:m;F=F==a.skipOptionalPartCharacter&&
    null===g.fn?g.def:F;q=b;if(l.refreshFromBuffer){q=l.refreshFromBuffer;c=!0;!0===q?(e.validPositions={},e.tests={},f(0,h().length)):f(q.start,q.end);if(void 0==l.pos)return l.pos=u(),!1;q=void 0!=l.pos?l.pos:b;k=v(q)[0]}else!0!==l&&l.pos!=b&&(q=l.pos,f(b,q),k=v(q)[0]);0<N&&p(!0);B(q,d.extend({},k,{input:r(F,g)}),c,E)||(l=!1);return!1}});return l}E=!0===E;var l=k(b,m,E,c);if(!E&&(a.insertMode||void 0==e.validPositions[z(b)])&&!1===l&&!s(b))for(var g=b+1,q=z(b);g<=q;g++)if(l=k(g,m,E,c),!1!==l){b=g;break}!0===
    l&&(l={pos:b});return l}function s(b){b=C(b);return null!=b.fn?b.fn:!1}function y(){var b;K=t.prop("maxLength");-1==K&&(K=void 0);if(!1==a.greedy){b=u()+1;for(var d=C(b);null!=d.fn||""!=d.def;)d=C(++b),!0!==d.optionality&&(d=v(b),d=d[d.length-1].match);b=g(!0,b).length;e.tests={}}else b=h().length;return void 0==K||b<K?b:K}function z(b){var d=y();if(b>=d)return d;for(;++b<d&&!s(b)&&(!0!==a.nojumps||a.nojumpsThreshold>b););return b}function x(b){if(0>=b)return 0;for(;0<--b&&!s(b););return b}function G(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              d,a){b._valueSet(d.join(""));void 0!=a&&w(b,a)}function P(b){var d=C(b);return null==d.fn?d.def:a.placeholder.charAt(b%a.placeholder.length)}function M(b,a,c,f,k){f=void 0!=f?f.slice():H(b._valueGet()).split("");p();a&&b._valueSet("");d.each(f,function(a,h){if(!0===k){var m=e.p,m=-1==m?m:x(m),f=-1==m?a:z(m);-1==d.inArray(h,n().slice(m+1,f))&&T.call(b,void 0,!0,h.charCodeAt(0),!1,c,a)}else T.call(b,void 0,!0,h.charCodeAt(0),!1,c,a),c=c||0<a&&a>e.p});a&&G(b,h(),z(u()))}function D(b){return d.inputmask.escapeRegex.call(this,
    b)}function H(b){return b.replace(RegExp("("+D(n().join(""))+")*$"),"")}function I(b){var d=h().slice(),a;for(a=d.length-1;0<=a;a--){var e=C(a);if((e.optionality||e.optionalQuantifier)&&d[a]==P(a))d.pop();else break}G(b,d)}function Q(b,m){if(!b.data("_inputmask")||!0!==m&&b.hasClass("hasDatepicker"))return b[0]._valueGet();var e=d.map(h(),function(b,d){return s(d)&&k(d,b,!0)?b:null}),e=(A?e.reverse():e).join(""),c=(A?h().reverse():h()).join("");return d.isFunction(a.onUnMask)?a.onUnMask.call(b,c,
    e,a):e}function J(b){!A||"number"!=typeof b||a.greedy&&""==a.placeholder||(b=h().length-b);return b}function w(b,h,e){b=b.jquery&&0<b.length?b[0]:b;if("number"==typeof h){h=J(h);e=J(e);e="number"==typeof e?e:h;var c=d(b).data("_inputmask")||{};c.caret={begin:h,end:e};d(b).data("_inputmask",c);d(b).is(":visible")&&(b.scrollLeft=b.scrollWidth,!1==a.insertMode&&h==e&&e++,b.setSelectionRange?(b.selectionStart=h,b.selectionEnd=e):b.createTextRange&&(b=b.createTextRange(),b.collapse(!0),b.moveEnd("character",
    e),b.moveStart("character",h),b.select()))}else return c=d(b).data("_inputmask"),!d(b).is(":visible")&&c&&void 0!=c.caret?(h=c.caret.begin,e=c.caret.end):b.setSelectionRange?(h=b.selectionStart,e=b.selectionEnd):document.selection&&document.selection.createRange&&(b=document.selection.createRange(),h=0-b.duplicate().moveStart("character",-1E5),e=h+b.text.length),h=J(h),e=J(e),{begin:h,end:e}}function O(b){if(d.isFunction(a.isComplete))return a.isComplete.call(t,b,a);if("*"!=a.repeat){var h=!1,e=x(y());
    if(u()==e)for(var h=!0,c=0;c<=e;c++){var f=s(c);if(f&&(void 0==b[c]||b[c]==P(c))||!f&&b[c]!=P(c)){h=!1;break}}return h}}function R(b){b=d._data(b).events;d.each(b,function(b,a){d.each(a,function(b,d){if("inputmask"==d.namespace&&"setvalue"!=d.type){var a=d.handler;d.handler=function(b){if(this.readOnly||this.disabled)b.preventDefault;else return a.apply(this,arguments)}}})})}function ga(b){function a(b){if(void 0==d.valHooks[b]||!0!=d.valHooks[b].inputmaskpatch){var e=d.valHooks[b]&&d.valHooks[b].get?
    ...
    Object.getOwnPropertyDescriptor&&(h=Object.getOwnPropertyDescriptor(b,"value"));if(h&&h.get){if(!b._valueGet){var e=h.get,c=h.set;b._valueGet=function(){return A?e.call(this).split("").reverse().join(""):e.call(this)};b._valueSet=function(b){c.call(this,A?b.split("").reverse().join(""):b)};Object.defineProperty(b,"value",{get:function(){var b=d(this),a=d(this).data("_inputmask"),h=a.maskset;return a&&a.opts.autoUnmask?b.inputmask("unmaskedvalue"):e.call(this)!=h._buffer.join("")?e.call(this):""},
        set:function(b){c.call(this,b);d(this).triggerHandler("setvalue.inputmask")}})}}else document.__lookupGetter__&&b.__lookupGetter__("value")?b._valueGet||(e=b.__lookupGetter__("value"),c=b.__lookupSetter__("value"),b._valueGet=function(){return A?e.call(this).split("").reverse().join(""):e.call(this)},b._valueSet=function(b){c.call(this,A?b.split("").reverse().join(""):b)},b.__defineGetter__("value",function(){var b=d(this),a=d(this).data("_inputmask"),h=a.maskset;return a&&a.opts.autoUnmask?b.inputmask("unmaskedvalue"):
        e.call(this)!=h._buffer.join("")?e.call(this):""}),b.__defineSetter__("value",function(b){c.call(this,b);d(this).triggerHandler("setvalue.inputmask")})):(b._valueGet||(b._valueGet=function(){return A?this.value.split("").reverse().join(""):this.value},b._valueSet=function(b){this.value=A?b.split("").reverse().join(""):b}),a(b.type))}function Z(b,d,c){if(a.numericInput||A){switch(d){case a.keyCode.BACKSPACE:d=a.keyCode.DELETE;break;case a.keyCode.DELETE:d=a.keyCode.BACKSPACE}A&&(b=c.end,c.end=c.begin,
    c.begin=b)}c.begin==c.end?(b=d==a.keyCode.BACKSPACE?c.begin-1:c.begin,a.isNumeric&&""!=a.radixPoint&&h()[b]==a.radixPoint&&(c.begin=h().length-1==b?c.begin:d==a.keyCode.BACKSPACE?b:z(b),c.end=c.begin),d==a.keyCode.BACKSPACE?c.begin=x(c.begin):d==a.keyCode.DELETE&&c.end++):1!=c.end-c.begin||a.insertMode||d==a.keyCode.BACKSPACE&&c.begin--;b=c.begin;var f=c.end;for(d=z(b-1);b<f;b++)delete e.validPositions[b];for(b=z(f-1);b<=u();b=z(b)){var f=e.validPositions[b],g=e.validPositions[d];void 0!=f&&void 0==
