				...
				<div class="box span7">
					...
					<div class="box-content">
						<ul class="ajax-loaders">
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-1.gif" title="img/ajax-loaders/ajax-loader-1.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-2.gif" title="img/ajax-loaders/ajax-loader-2.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-3.gif" title="img/ajax-loaders/ajax-loader-3.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-4.gif" title="img/ajax-loaders/ajax-loader-4.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-5.gif" title="img/ajax-loaders/ajax-loader-5.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-6.gif" title="img/ajax-loaders/ajax-loader-6.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-7.gif" title="img/ajax-loaders/ajax-loader-7.gif" ></li>
														<li><img src="/static/theme/manage/img/ajax-loaders/ajax-loader-8.gif" title="img/ajax-loaders/ajax-loader-8.gif" ></li>
												</ul>
