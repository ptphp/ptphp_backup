...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/static/theme/industry/css/bootstrap.css" />
    <link rel="stylesheet" href="/static/theme/industry/css/bootstrap-responsive.css" />
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic" />
    <link rel="stylesheet" href="/static/theme/industry/css/styles.css" />
    <link rel="stylesheet" href="/static/theme/industry/css/toastr.css" />
    <link rel="stylesheet" href="/static/theme/industry/css/fullcalendar.css" />
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
    <script src="/static/theme/industry/js/bootstrap.js"></script>
    <script src="/static/theme/industry/js/jquery.knob.js"></script>
    <script src="http://d3js.org/d3.v3.min.js"></script>
    <script src="/static/theme/industry/js/jquery.sparkline.min.js"></script>
    <script src="/static/theme/industry/js/toastr.js"></script>
    <script src="/static/theme/industry/js/jquery.tablesorter.min.js"></script>
    <script src="/static/theme/industry/js/jquery.peity.min.js"></script>
    <script src="/static/theme/industry/js/fullcalendar.min.js"></script>
    <script src="/static/theme/industry/js/gcal.js"></script>
    <script src="/static/theme/industry/js/setup.js"></script>
...
(function() {
  ...
  <script src="/static/theme/industry/js/d3-setup.js"></script><script>protocol = window.location.protocol === 'http:' ? 'ws://' : 'wss://'; address = protocol + window.location.host + window.location.pathname + '/ws'; socket = new WebSocket(address);
