    ...
    <div class="container-fluid">
        ...
        <ul class='mini'>
            <li class='dropdown dropdown-noclose supportContainer'>
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show ticket"><img src="/static/theme/neat/img/icons/fugue/magnifier.png" alt=""></a>
                                <a href="#" class='tip btn btn-mini' title="Delete ticket"><img src="/static/theme/neat/img/icons/fugue/cross.png" alt=""></a>
                            </div>
                        </div>
                    </li>
                    <li class='custom'>
            ...
            <li class='dropdown pendingContainer'>
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show order"><img src="/static/theme/neat/img/icons/fugue/magnifier.png" alt=""></a>
                                <a href="#" class='tip btn btn-mini' title="Delete order"><img src="/static/theme/neat/img/icons/fugue/cross.png" alt=""></a>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <li class='dropdown messageContainer'>
                <a href="#" class='dropdown-toggle' data-toggle='dropdown'>
                    <img src="/static/theme/neat/img/icons/fugue/balloons-white.png" alt="">
                    Messages
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show message"><img src="/static/theme/neat/img/icons/fugue/magnifier.png" alt=""></a>
                                <a href="#" class='tip btn btn-mini' title="Reply message"><img src="/static/theme/neat/img/icons/fugue/mail-reply.png" alt=""></a>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <li>
                <a href="index.html">
                    <img src="/static/theme/neat/img/icons/fugue/control-power.png" alt="">
                    Logout
                </a>
            </li>
        </ul>
