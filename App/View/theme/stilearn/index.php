...
<html lang="en">
    <head>
        ...
        <!-- styles -->
        <link href="/static/theme/stilearn/css/bootstrap.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/bootstrap-responsive.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/stilearn.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/stilearn-responsive.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/stilearn-helper.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/stilearn-icon.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/font-awesome.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/animate.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/uniform.default.css" rel="stylesheet" />

        <link href="/static/theme/stilearn/css/select2.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/fullcalendar.css" rel="stylesheet" />
        <link href="/static/theme/stilearn/css/bootstrap-wysihtml5.css" rel="stylesheet" />
    ...
    <body>
                        ...
                        <div class="panel-ext">
                                ...
                                <ul class="dropdown-menu dropdown-notification">
                                    ...
                                    <li class="new">
                                        <a href="#">
                                            ...
                                            <div class="media">
                                                <img class="media-object pull-left" data-src="/static/theme/stilearn/js/holder.js/64x64" />
                            ...
                            <div class="btn-group user-group">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <img class="corner-all" align="middle" src="/static/theme/stilearn/img/user-thumb.jpg" title="John Doe" alt="john doe" /> <!--this for display on PC device-->
                                    ...
                                    <li>
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img class="img-circle" src="/static/theme/stilearn/img/user.jpg" title="profile" alt="profile" />
                                            </a>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="recent-orders">
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object" data-src="/static/theme/stilearn/js/holder.js/64x64" />
                                                        </a>
                                                        <div class="media-body">
                                                ...
                                                <li class="contact-alt grd-white">
                                                    ...
                                                    <a href="#chat" data-toggle="tab" data-id="iin@mail.com">
                                                        ...
                                                        <div class="contact-item">
                                                            <div class="pull-left">
                                                                <img class="contact-item-object" style="width: 32px;height: 32px;" src="/static/theme/stilearn/img/user-thumb-mini.jpg" />
                                                            </div>
                                        ...
                                        <div class="side-task">
                                            <div class="task active">
                                                <span class="task-header">
                                                    <img src="/static/theme/stilearn/img/loader_16.gif" /> 
        ...
        <script src="/static/theme/stilearn/js/jquery.js"></script>
        <script src="/static/theme/stilearn/js/jquery-ui.min.js"></script>
        <script src="/static/theme/stilearn/js/bootstrap.js"></script>
        <script src="/static/theme/stilearn/js/uniform/jquery.uniform.js"></script>
        <script src="/static/theme/stilearn/js/peity/jquery.peity.js"></script>

        <script src="/static/theme/stilearn/js/select2/select2.js"></script>
        <script src="/static/theme/stilearn/js/knob/jquery.knob.js"></script>
        <script src="/static/theme/stilearn/js/flot/jquery.flot.js"></script>
        <script src="/static/theme/stilearn/js/flot/jquery.flot.resize.js"></script>
        <script src="/static/theme/stilearn/js/flot/jquery.flot.categories.js"></script>
        <script src="/static/theme/stilearn/js/wysihtml5/wysihtml5-0.3.0.js"></script>
        <script src="/static/theme/stilearn/js/wysihtml5/bootstrap-wysihtml5.js"></script>
        <script src="/static/theme/stilearn/js/calendar/fullcalendar.js"></script> <!-- this plugin required jquery ui-->

        <!-- required stilearn template js, for full feature-->
        <script src="/static/theme/stilearn/js/holder.js"></script>
        <script src="/static/theme/stilearn/js/stilearn-base.js"></script>
