...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/static/theme/unicorn/css/bootstrap.min.css" />
		<link rel="stylesheet" href="/static/theme/unicorn/css/bootstrap-responsive.min.css" />
		<link rel="stylesheet" href="/static/theme/unicorn/css/fullcalendar.css" />	
		<link rel="stylesheet" href="/static/theme/unicorn/css/unicorn.main.css" />
		<link rel="stylesheet" href="/static/theme/unicorn/css/unicorn.grey.css" class="skin-color" />
	...
	<body>
		...
		<div id="content">
								...
								<ul class="recent-posts">
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="/static/theme/unicorn/img/demo/av2.jpg" />
										</div>
									...
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="/static/theme/unicorn/img/demo/av3.jpg" />
										</div>
										<div class="article-post">
									...
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="/static/theme/unicorn/img/demo/av1.jpg" />
										</div>
										<div class="article-post">
            ...
            <script src="/static/theme/unicorn/js/excanvas.min.js"></script>
            <script src="/static/theme/unicorn/js/jquery.min.js"></script>
            <script src="/static/theme/unicorn/js/jquery.ui.custom.js"></script>
            <script src="/static/theme/unicorn/js/bootstrap.min.js"></script>
            <script src="/static/theme/unicorn/js/jquery.flot.min.js"></script>
            <script src="/static/theme/unicorn/js/jquery.flot.resize.min.js"></script>
            <script src="/static/theme/unicorn/js/jquery.peity.min.js"></script>
            <script src="/static/theme/unicorn/js/fullcalendar.min.js"></script>
            <script src="/static/theme/unicorn/js/unicorn.js"></script>
            <script src="/static/theme/unicorn/js/unicorn.dashboard.js"></script>
	</body>
</html>
